package steven.springframework.recipe_app.bootstrap;
...
import steven.springframework.recipe_app.models.Ingredient;
...
import steven.springframework.recipe_app.repositories.CategoryRepo;
import steven.springframework.recipe_app.repositories.RecipeRepo;
import steven.springframework.recipe_app.repositories.UnitOfMeasureRepo;
...
//    guacNotes.setRecipe(guacRecipe);
    ...
    guacRecipe.addIngredient(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(
        ".5"), eachUom));
